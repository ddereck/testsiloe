...
class EnvDatas {
  ...
  /// The SupabaseUrl variable.
	/// The SupabaseKey variable.
	/// The AppStatus variable.
	/// The AppEnvironnement variable.
  static const String supabaseUrl = "SupabaseUrl";
	static const String supabaseKey = "SupabaseKey";
	static const String appStatus = "AppStatus";
	static const String appEnvironnement = "AppEnvironnement";
}
