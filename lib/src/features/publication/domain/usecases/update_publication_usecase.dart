...
/// A concrete implementation of [UpdatePublicationUseCase] with parameters.
///
/// This class requires a [PublicationRepository] to function.
/// It calls the repository method with the given parameters.
class UpdatePublicationUseCase
    implements UseCase<EntityPublication, UpdatePublicationUseCaseParams> {
  /// Repository to interact with data layer.
  final PublicationRepository repository;

  /// Constructor for the use case, requiring a [repository].
  const UpdatePublicationUseCase({required this.repository});
  ...
  Future<(Failure?, EntityPublication?)> call(
      UpdatePublicationUseCaseParams params) async {
    return await repository.updatePublication(
      id: params.id,
...
/// Parameter class for [UpdatePublicationUseCaseParams].
///
/// Contains all the attributes required for the use case.
class UpdatePublicationUseCaseParams {
  final int id;
  ...
  /// Creates an instance of [UpdatePublicationUseCaseParams].
  const UpdatePublicationUseCaseParams({
    required this.id,
