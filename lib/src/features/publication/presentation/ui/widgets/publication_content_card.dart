      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Category and Date
                Text(
                  '${widget.publication.categorie?.nomCategorie ?? 'Catégorie'} • ${TimeConfig.formatDateFr(widget.publication.datePublication)}',
                  style: TextStyle(
                    fontSize: 12,
                ...
                // Title (as description snippet)
                Text(
                  widget.publication.titre ?? 'Aucun titre',
                  maxLines: 2,
          ...
          const Padding(
            ...
            child: Icon(TablerIcons.cross, color: Colors.black),
          ),
        ],
      ),
    );
