...
import '../../../commons/ui/widgets/menu_card.dart';
...
import '../adapters/upsert_article_ui_controller.dart';

class AddArticleUI extends StatelessWidget {
  const AddArticleUI({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        TopbarWidget(title: "Publication"),
        Expanded(
          child: GestureDetector(
            ...
            child: Form(
              key: controller.addArticleFormState,
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                          ...
                          DropdownButtonFormField<EntityPublicationType>(
                            ...
                            items: publicationTypesUIController
                              ...
                              return DropdownMenuItem<EntityPublicationType>(
                                value: category,
                                child: Text(category.typePublication ?? "Article"),
                              );
                            }).toList(),
                    ...
                    // Description/Contenu: toujours obligatoire
                    ...
                    // Contenu/URL dynamiques selon type de publication
                    Obx(() {
                      final type = controller.selectedContentType.value?.typePublication?.toLowerCase();
                      if (type == 'video') {
                        return Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Lien Youtube", style: TextStyle(fontWeight: FontWeight.bold)),
                            TextFieldEditWidget(
                              ...
                              blocColor: Theme.of(context).highlightColor,
                              validator: (value) => FieldFormatter.validatorUrl(value),
                            ),
                          ],
                        );
                      } else if (type == 'audio') {
                        ...
                        return Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Rédigez votre article", style: TextStyle(fontWeight: FontWeight.bold)),
                            TextFieldEditWidget(
                              controller: controller.textArticleController,
                              inputColor: Theme.of(context).highlightColor,
                              hint: "Saisir la rédaction complète de votre article",
                              withTitleWhenTexting: false,
                        ...
                        return const SizedBox.shrink(); // Aucun champ dynamique si rien sélectionné
                      }
                    }),
